...
\begin{figure}
%\plottwo{Plots/r_1e6/GFdensity.eps}{Plots/r_1e6/GFwddensity.eps}\\
%\plottwo{Plots/r_1e6/GFbhbdensity.eps}{Plots/r_1e6/GFcolor.eps}
...
%from /local/tmp/selfcal_runs/July_rev/test2/r_band_fppatches/input_illum_err.eps
%\begin{figure}
%\plottwo{Plots/u_band/input_illum_err.eps}{Plots/r_band/input_illum_err.eps}
...
%photometric calibration procedure for LSST. 
...
\begin{figure}
\plottwo{Plots/r_1e6_8hp/HPid.eps}{Plots/r_1e6/HPid.eps}
...
\begin{figure}
\plottwo{Plots/r_1e6_regsolver/Sdmag.eps}{Plots/r_1e6/Sdmag.eps} \\
\plottwo{Plots/r_1e6_regsolver/Sdamg_hist.eps}{Plots/r_1e6/Sdamg_hist.eps}  
%\plottwo{Plots/r_1e6_regsolver/Srepeat_IQR.eps}{Plots/r_1e6/Srepeat_IQR.eps} 
%\plottwo{Plots/r_1e6_regsolver/Srepeat_IQR_bright_hist.eps}{Plots/r_1e6/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\plottwo{Plots/r_1e6/Snobs.eps}{Plots/r_1e6_nodither/Snobs.eps}\\
\plottwo{Plots/r_1e6/Sdmag.eps}{Plots/r_1e6_nodither/Sdmag.eps}\\
\plottwo{Plots/r_1e6/Sdamg_hist.eps}{Plots/r_1e6_nodither/Sdamg_hist.eps}
...
\begin{figure}
\plottwo{Plots/r_1e6/Snobs.eps}{Plots/r_1e6/Snobs_hist.eps} \\
\plottwo{Plots/r_1e6/Sdmag.eps}{Plots/r_1e6/Sdamg_hist.eps} \\
\plottwo{Plots/r_1e6/Srepeat_IQR.eps}{Plots/r_1e6/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\plottwo{Plots/r_1e6/repeat_examples_hist.eps}{Plots/r_1e6/repeat_examples_cdf.eps}
...
\begin{figure}
\plottwo{Plots/r_1e6/Sdmag.eps}{Plots/r_1e6_newseed/Sdmag.eps} \\
\plottwo{Plots/r_1e6/Sdamg_hist.eps}{Plots/r_1e6_newseed/Sdamg_hist.eps} \\
\plottwo{Plots/r_1e6/Srepeat_IQR_bright_hist.eps}{Plots/r_1e6_newseed/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\plottwo{Plots/25mil/Sdensity.eps}{Plots/25mil/Sdepth90.eps}
\plottwo{Plots/25mil/Pnstars_hist.eps}{Plots/25mil/Pzphist.eps}
...
\begin{figure}
\plottwo{Plots/25mil/Snobs.eps}{Plots/25mil/Snobs_hist.eps} \\
\plottwo{Plots/25mil/Sdmag.eps}{Plots/25mil/Sdamg_hist.eps} \\
\plottwo{Plots/25mil/Srepeat_IQR.eps}{Plots/25mil/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\epsscale{0.3}
\plotone{Plots/r_1e6_1yr/Snobs.eps}\plotone{Plots/r_1e6_1yr/Sdmag.eps}\plotone{Plots/r_1e6_1yr/Sdamg_hist.eps} \\
\plotone{Plots/r_1e6/Snobs.eps}\plotone{Plots/r_1e6/Sdmag.eps}\plotone{Plots/r_1e6/Sdamg_hist.eps} \\
\plotone{Plots/r_1e6_5yr/Snobs.eps}\plotone{Plots/r_1e6_5yr/Sdmag.eps}\plotone{Plots/r_1e6_5yr/Sdamg_hist.eps} \\
\plotone{Plots/r_1e6_10yr/Snobs.eps}\plotone{Plots/r_1e6_10yr/Sdmag.eps}\plotone{Plots/r_1e6_10yr/Sdamg_hist.eps} 
\epsscale{1}
...
\begin{figure}
%\plottwo{Plots/mag_recover/20per_results/Sdmag.eps}{Plots/mag_recover/80per_results/Sdmag.eps} \\
%\plottwo{Plots/mag_recover/20per_results/Sdamg_hist.eps}{Plots/mag_recover/80per_results/Sdamg_hist.eps} \\
%\plottwo{Plots/mag_recover/20per_results/Srepeat_IQR_bright_hist.eps}{Plots/mag_recover/80per_results/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
%\plottwo{Plots/u_1e6_neg15/Saccuracyvcolor.eps}{Plots/u_1e6_moreghost_small/Saccuracyvcolor_mod.eps}
...
%\begin{figure}
%\epsscale{.75}
%\plottwo{Plots/flux_color/coloru_g.eps} {Plots/flux_color/map_coloru_g.eps} \\
%\plottwo{Plots/flux_color/colorg_r.eps}{Plots/flux_color/map_colorg_r.eps} \\
%\plottwo{Plots/flux_color/colorr_i.eps}{Plots/flux_color/map_colorr_i.eps} \\
%\plottwo{Plots/flux_color/colori_z.eps}{Plots/flux_color/map_colori_z.eps} \\
%%\plottwo{Plots/flux_color/colorz_y.eps}{Plots/flux_color/map_colorz_y.eps} 
%\epsscale{1}
...
\begin{figure}
\plottwo{Plots/u_1e6_neg15/Snobs.eps}{Plots/u_1e6_neg15/Snobs_hist.eps} \\
\plottwo{Plots/u_1e6_neg15/Sdmag.eps}{Plots/u_1e6_neg15/Sdamg_hist.eps} \\
\plottwo{Plots/u_1e6_neg15/Srepeat_IQR.eps}{Plots/u_1e6_neg15/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\plottwo{Plots/u_1e6_uselect/Snobs.eps}{Plots/u_1e6_uselect/Snobs_hist.eps} \\
\plottwo{Plots/u_1e6_uselect/Sdmag.eps}{Plots/u_1e6_uselect/Sdamg_hist.eps} \\
\plottwo{Plots/u_1e6_uselect/Srepeat_IQR.eps}{Plots/u_1e6_uselect/Srepeat_IQR_bright_hist.eps}
...
\begin{figure}
\plottwo{Plots/g_1e6/Snobs.eps}{Plots/g_1e6/Snobs_hist.eps} \\
\plottwo{Plots/g_1e6/Sdmag.eps}{Plots/g_1e6/Sdamg_hist.eps} \\
\plottwo{Plots/g_1e6/Srepeat_IQR.eps}{Plots/g_1e6/Srepeat_IQR_bright_hist.eps}
\caption{ {\bf Full-Sky, Low-Density simulation for the $g$-filter.}  \label{fig:g1e6}}
\end{figure}
 

\begin{figure}
\plottwo{Plots/i_1e6/Snobs.eps}{Plots/i_1e6/Snobs_hist.eps} \\
\plottwo{Plots/i_1e6/Sdmag.eps}{Plots/i_1e6/Sdamg_hist.eps} \\
\plottwo{Plots/i_1e6/Srepeat_IQR.eps}{Plots/i_1e6/Srepeat_IQR_bright_hist.eps}
\caption{ {\bf Full-Sky, Low-Density simulation for the $i$-filter.}  \label{fig:i1e6}}
\end{figure}

\begin{figure}
\plottwo{Plots/z_1e6/Snobs.eps}{Plots/z_1e6/Snobs_hist.eps} \\
\plottwo{Plots/z_1e6/Sdmag.eps}{Plots/z_1e6/Sdamg_hist.eps} \\
\plottwo{Plots/z_1e6/Srepeat_IQR.eps}{Plots/z_1e6/Srepeat_IQR_bright_hist.eps}
\caption{ {\bf Full-Sky, Low-Density simulation for the $z$-filter.}  \label{fig:z1e6}}
\end{figure}

\begin{figure}
\plottwo{Plots/y_1e6/Snobs.eps}{Plots/y_1e6/Snobs_hist.eps} \\
\plottwo{Plots/y_1e6/Sdmag.eps}{Plots/y_1e6/Sdamg_hist.eps} \\
\plottwo{Plots/y_1e6/Srepeat_IQR.eps}{Plots/y_1e6/Srepeat_IQR_bright_hist.eps}
...
%\begin{figure}
%\plottwo{Plots/r_hd_test/Snobs.eps}{Plots/r_hd_test/Snobs_hist.eps} \\
%\plottwo{Plots/r_hd_test/Sdmag.eps}{Plots/r_hd_test/Sdamg_hist.eps} \\
%\plottwo{Plots/r_hd_test/Srepeat_IQR.eps}{Plots/r_hd_test/Srepeat_IQR_bright_hist.eps}
