...
known with an rms\footnote{this is actually 1 number per band ... how
  can one number have an rms?} accuracy of 5 millimags for any color not involving $u$
...
mags) with an rms\footnote{Again, one number .. we could have an
uncertainty of 10 mmag, but I don't understand how this becomes an
rms} accuracy of 10 millimags. This requirement ties LSST internal
...
\caption{ {\small {\bf A flowchart of the Data Release photometric
    ...
    red circles point out significant LSST-specific calibration
...
The rest of this section will provide a more in-depth overview of the calibration measurements
