...
but also on the magnitude of those perturbations.   This is shown in Figures x - y, which present
...
The impact of zeropoint variations on calibration performance as a whole will depend strongly on
the pdf of the cloud extinction, as shown by Figures x - y.  This dependence derives partly from
the fact that increasing extinction increases the photometric errors in the measurements of the
calibration stars.  Our current data supports only a 
crude measure of this pdf, and there are consequently uncertainties in the overall distribution of
