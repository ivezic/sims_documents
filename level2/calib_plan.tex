...
example a variation in color calibration across the sky.  Our current simulations (Section \ref{sec:verification})
...
and include not only the four fundamental standards (\citep{Bohlin2004}), but also a growing set from
the HST program of Saha et al, for which observations are still underway.}
...
\citep{1992JRASC..86..309B}, and a `white dwarf
...
\begin{tabular}{l | c c c c c c }
 &   $u$  & $g$ & $r$ & $i$ & $z$ & $y$ \\ \hline
{\bf Simulation Result (RMS)}  & 8.0 & 2.0 & 1.6 & 1.8 & 2.3 & 21.8 \\ \hline
