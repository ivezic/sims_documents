...
will be generated using a combination of spectroscopic measurements of
bright stars obtained with the auxiliary telescope and an atmospheric
extinction model that combines knowledge of the spatial and temporal
variation of the atmosphere and atmospheric transmission profiles
generated using MODTRAN4 \citep{modtran4a, modtran4b}.
