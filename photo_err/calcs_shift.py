...
for f in filterlist:
    pylab.figure()
    pylab.plot(fs.radii, numpy.mean(dmags[f][condition1], 0), color='g', marker='o', label='g-i~0.5')
    pylab.plot(fs.radii, numpy.mean(dmags[f][condition2], 0), color='r', marker='o', label='g-i~-0.5')
