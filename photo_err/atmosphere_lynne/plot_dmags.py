...
from lsst.sims.atmosphere.transmission.atmoComp import AtmoComp
...
def plot_colorcolor(mags, sedkeylist, sedcolorkey, sedtype, filterlist, titletext=None, newfig=True):
    if newfig:
        pylab.figure()
...
def calc_deltamags(mags1 ,mags2, flist=filterlist):
    dmags = {}
    for f in flist:
