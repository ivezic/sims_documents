...
$T_{O2}(X)$ is the template profile from MODTRAN). Each of
...
The coefficients $C_{mol/O3/H2O}$ and aerosol extinction are
determined using spectra of bright stars obtained from the 1.2-m LSST
auxiliary telescope which will be equipped with a modest resolution
(R$\sim400$) spectrograph. The auxiliary telescope will generally
not observe stars along the line of sight of LSST

The stars observed with the auxiliary telescope
