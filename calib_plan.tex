...
will be wavelength dependent; for the narrow band flat fields, an illumination
correction for each wavelength must be generated.  The illumination correction
...
view during specialized observing sequences and further corrections generated
by the self-calibration stage (discussed below). For the narrow band flat fields,
ZEMAX models of the ghost patterns at various wavelengths will be generated, constrained
by measurements at various wavelengths obtained with the `camera calibration optical
bench' (CCOB), single-point illumination on the dome screen, and observations
of emission line sources.  The illumination correction is expected to be
