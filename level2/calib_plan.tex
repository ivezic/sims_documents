...
LSST will incorporate some significant improvements over PS-1:
...
The first mitigation that we will develop is a more rigorous treatment of finite PSF effects, 
along the lines of equation \ref{eqn:xx}.  We have some reason to expect that this may lower the
...
\begin{itemize}
\item {Simulation tools may produce misleading results because their development is still ongoing, and
