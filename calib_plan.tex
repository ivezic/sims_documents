...
\begin{figure}[htp]
\centering
\subfloat[\citet{Stubbs2010}]{\includegraphics[width=3.5in]{NIST_diode}} \\
...
NIST-calibrated photodiode, from \citet{Stubbs2010} and
...
or a 0.5\% error in photodiode calibration assuming that each bandpass
is measured at approximately 100 separate wavelengths -- then the
observed magnitudes can be calibrated to better than 1~mmag for all
bandpasses other than $u$, where the error could be as much as 5~mmag
for certain main sequence stars (see
...
the filter response curves vary linearly with radius, to remain below 
the 
...
\caption{{\small 
{\bf Baseline filter curves and a potential shift due to nonuniformity.}
