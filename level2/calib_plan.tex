...
We do not specifically account for them in the calibration error budget.
...
flat (Section \ref{sec:synthflat}}
...
(\citep{Radomski2010}, \citep{Gaffard2003}).  Their data will be logged through the Engineering and Facility Data Base. 
...
was undertaken.  We are sensitive to systematic errors in the photodiode response rather than to noise, which can be effectively averaged over.  Figure \ref{fig:PDerrs} estimates the level of these systematic errors as 2 mmag at 400nm, 1 mmag between 470 and 950nm,
...
\item{Uncertainties in filter bandpass due to variation in position with respect to the optical axis}
...
& Filter positioning errors & 0.5 & 0.5 & 0.5 & 0.5 & 0.5 & 0.5 \\ 
& {\bf Total} & 6.7 & 2.5 & 1.0 & 0.8 & 1.2 & 2.2 \\ \hline
$Z_b^{obs}$ & & & & \\
...
{\bf Total Estimate} & & 7.5 & 4.1 & 3.5 & 3.4 & 3.5 & 4.0 \\ 
