...
\begin{itemize}
\item{Apply the monochromatic illumination correction (see Section \ref{sec:ic})}
\item{Normalize fluxes across wavelengths using the photodiode monitors}
\item{Correct for pixel geometry}
\end{itemize}

Further processing constructs
a synthetic broadband flat field ('BBF') that will be used to flatten incoming science exposures.
The broadband flat then
