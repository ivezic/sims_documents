...
\caption{ {\small {\bf Flat Spectrum Flat Determination.} Determination of the flat spectrum flat (FSF) is of central importance.  The initial step in the calibration process treats all objects as if their SED were flat.  This is consistent only if the flatfield is that for a flat SED as well.  Since the illumination source for the actual broadband flat does not have a flat SED, correction is required.  Additionally, the flat as measured is contaminated by light which arrives from paths other than the direct path, such as ghosting.  These effects must be taken out by the illumination correction. }
\label{fig:overview_flowchart2} }
\end{figure}

\begin{figure}[htbp]
\includegraphics[width=6.5in]{CalibDataProdSchematic3}
\caption{ {\small {\bf System Bandpass Determination.} Blah, blah. }
\label{fig:overview_flowchart3} }
\end{figure}

\begin{figure}[htbp]
\includegraphics[width=6.5in]{CalibDataProdSchematic4}
\caption{ {\small {\bf Science Object Calibration.} Blah, blah. }
...
{\bf TODO - Tim and Peter - New section on testing and verification,
particularly verification of uniformity over entire sky, but should
cover testing of all of above requirements - including external
calibration.}
