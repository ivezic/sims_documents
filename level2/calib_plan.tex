...
\item{Errors in the atmospheric bandpass, $S^{atm}$
	...
	Figure \ref{fig:xx}, which is for a variation of 5mm, this translates to errors of 0.2 mmag in u-band, negligible in g,r, and i-bands, 1 mmag in z, and 2mmag in y.
	 
	\item{Unmodelled spatial and/or temporal variation of atmospheric components, particularly aerosols and water vapor.
	%We can somehow estimate a gradient, then apply it across the difference between probe stars.  Or just use 5\%?}
	\end{itemize}
	}
...
{\bf $\Delta m_b^{obs}$} & & & & \\
& Auxiliary telescope spectrum errors & 0.2 & 0 & 0 & 0 & 1.0 & 2.0  \\
