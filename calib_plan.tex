...
$S_b^{sys}(\lambda,x,y,t)$. We can measure the rapidly varying gray-scale normalization changes
using standard white-light flat fields acquired at the start and end of each night, 
in a similar manner as traditional dome flats are acquired. 

XXX

 By using a dome-screen system that is
