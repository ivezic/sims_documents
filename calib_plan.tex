...
bright stars obtained with the auxiliary telescope and a model of
the atmospheric extinction which uses our knowledge of the
typical spatial and temporal variation of the atmosphere plus
atmospheric transmission profiles generated using MODTRAN
\citep{modtran4a, modtran4b}.
