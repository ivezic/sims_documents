...
\begin{figure}[htp]
\centering
\subfloat[\citet{Stubbs2010}]{\includegraphics[width=4in]{NIST_diode}} \\
...
photodiode, from \citet{Stubbs2010} (upper panel) and
\citet{Eppeldauer09} (lower panel).}  Between 400 and 900~nm,
calibration methods already in use in experimental hardware response
measurement systems indicate photodiode accuracy is better than 0.1\%,
as shown in the top panel. The jump in calibration accuracy below
...
down to 1600~nm, as shown in the bottom panel.}
}
