...
\begin{figure}
\plottwo{Plots/u_1e6_uselect/Snobs.png}{Plots/u_1e6_uselect/Snobs_hist.png} \\
\plottwo{Plots/u_1e6_uselect/Sdmag.png}{Plots/u_1e6_uselect/Sdamg_hist.png} \\
\plottwo{Plots/u_1e6_uselect/Srepeat_IQR.png}{Plots/u_1e6_uselect/Srepeat_IQR_bright_hist.png}
\caption{ {\bf Full-Sky, Low-Density simulation for the $u$-filter}.  Unlike Figure~\ref{fig:u1e6}, this simulation used a stellar catalog selected to be near 17 mag in $u$ ranther than $r$, resulting in much higher signal-to-noise. \label{fig:u1e6_uselect}}
\end{figure}
...
\begin{figure}
\plottwo{Plots/25mil/Sdensity.png}{Plots/25mil/Sdepth90.png}
\plottwo{Plots/25mil/Pnstars_hist.png}{Plots/25mil/Pzphist.png}
